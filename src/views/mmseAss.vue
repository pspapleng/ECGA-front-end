        ...
        <div class="column is-8">
            ...
            <div class="card-content">
              <div class="content">
                <p>
                  ...
                  คุณ (ตา, ยาย, ...) ตั้งใจฟังให้ดีนะ เพราะจะบอกเพียงครั้งเดียว
                  ไม่มีการบอกซ้ำอีก เมื่อผม (ดิฉัน) พูดจบให้คุณ (ตา, ยาย, ...)
              ...
              <div class="card-content">
                <div class="content">
                  <p>
                    ...
                    คำว่ามะนาวสะกดว่า มอม้า-สระอะ-นอหนู-สระอา-วอแหวน ไหนคุณ (ตา,
                    ยาย, ...) สะกดถอยหลังให้ฟังหน่อย"
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="card" id="description">
            <div class="card-content">
              <div class="content">
                <p>
                  "ฟังดี ๆ นะ เดี๋ยวผม (ดิฉัน) จะส่งกระดาษให้คุณ แล้วให้คุณ (ตา
                  , ยาย, ...) รับด้วยมือขวา พับครึ่งกระดาษ แล้ววางไว้ที่...
                  (พื้น, โต๊ะ, เตียง)"
                </p>
              </div>
            </div>
